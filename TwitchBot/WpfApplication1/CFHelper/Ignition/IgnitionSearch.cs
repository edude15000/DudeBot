...
{
    class IgnitionSearch
    {
        private string CFUserID;

        private int drawpass = 0;
        private CookieContainer ignitionRequestCookies = new CookieContainer();
        ...
        /// </summary>
        public CDLCEntryList Search(int startrow, int numrows, string artist = "", string song = "", string album = "")
        {
            ...
            using (HttpClient cl = new HttpClient(handler, true))
            {
                ...
                postvars.Add("columns[1][search][value]", artist);
                ...
                postvars.Add("columns[2][search][value]", song);
                ...
                postvars.Add("columns[3][search][value]", album);
